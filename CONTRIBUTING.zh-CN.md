...
| **`yume-dsl-markdown-it`**                                                         | markdown-it 插件 — Markdown 中渲染 DSL（本仓库） |
...
```
fix(markdown-it): 修复 createText 未转义 HTML 的问题
```
...
- 保持运行时依赖最小化。本包应聚焦于 markdown-it 集成逻辑。
...
请使用 [Bug 报告](https://github.com/chiba233/yume-dsl-markdown-it/issues/new?template=bug_report.yml) 模板，包含：
...
请使用 [功能建议](https://github.com/chiba233/yume-dsl-markdown-it/issues/new?template=feature_request.yml) 模板。
